...
| Tool | Description |
|------|-------------|
| `get_user_info` | Get profile information for one or more phone numbers (optional `save_names` to store names locally) |
...
| `sync_contact_names` | Fetch WhatsApp profile names and store them for chats that still show as raw JIDs |
