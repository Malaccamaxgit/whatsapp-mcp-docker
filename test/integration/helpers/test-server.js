 ...
 * @returns {Promise<[InMemoryTransport, InMemoryTransport]>}
 */
export async function createInMemoryTransport() {
 ...
 * @param {Object} [options.waClient] - Mock WhatsApp client (default: createMockWaClient())
 * @param {Object} [options.store] - MessageStore instance
 * @param {Object} [options.permissions] - PermissionManager instance
 * @returns {{ client, mcpServer, store, audit, permissions, waClient, cleanup }}
 */
